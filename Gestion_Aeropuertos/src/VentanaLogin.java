...
public class VentanaLogin extends JFrame {
	...
	//private Image img_logo = new ImageIcon(VentanaLogin.class.getResource("res/avion.png")).getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
	//private Image img_username = new ImageIcon(VentanaLogin.class.getResource("res/persona.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	//private Image img_password = new ImageIcon(VentanaLogin.class.getResource("res/lock.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	//private Image img_log_in = new ImageIcon(VentanaLogin.class.getResource("res/key.png")).getImage().getScaledInstance(30, 40, Image.SCALE_SMOOTH);
